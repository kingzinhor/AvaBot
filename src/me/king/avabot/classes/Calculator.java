...
public class Calculator {
    ...
    public static double calc(String sentence, MessageReceivedEvent event) throws Exception {
        ...
        if (isValidSentence(sentence)){
            ...
            Useful.sendMessage(event.getChannel(), "Starting with: `" + sentence + "`");
            ...
            while (haveBrackets(sentence)){
                ...
                for (char c : sentence.toCharArray()) {
                    if (c == '('){
                        ...
                        sentence = start + calc(middleWithNoBrackets, event) + end;
